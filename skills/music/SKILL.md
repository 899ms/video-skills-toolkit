...
1. Read [Generated Music Registry](references/generated_music.md) before calling the API. Search by use case, mood, BPM, tags, and prompt. Audition and reuse a suitable recorded audio file when available. Reusing a prompt alone still triggers a paid generation; reuse its linked audio file to avoid spending credits.
...
- [Generated Music Registry](references/generated_music.md) — read before generating workspace BGM and update after every successful generation
