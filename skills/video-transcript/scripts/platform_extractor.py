...
def launch_chromium(p, headless: bool = True, **kwargs):
    """Prefer system Chrome when bundled Playwright Chromium is unavailable."""
    try:
        return p.chromium.launch(channel="chrome", headless=headless, **kwargs)
    except Exception:
